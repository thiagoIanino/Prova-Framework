...
const CustomPaginationActionsTable2 =() => {
    ...
    useEffect(() => {
        axios.get<PostsResponse[]>('https://jsonplaceholder.typicode.com/albums')
            .then(response => {
...
export default CustomPaginationActionsTable2